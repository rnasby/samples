...
public class CarModelsControllerTest {
    static private final String API = "car-models";
    ...
    void returnExistingMake() {
        ...
        assertThat((String)json.read("$.name")).isEqualTo("Camry");
        assertThat((Number)json.read("$.make_id")).isEqualTo(1);
        assertThat((Number)json.read("$.year")).isEqualTo(2020);
        assertThat((Number)json.read("$.price")).isEqualTo(24000.00);
    }
